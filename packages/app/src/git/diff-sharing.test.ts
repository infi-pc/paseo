import { emptyChangeBreakdown } from "@getpaseo/protocol/diff-stat";
...
const fileChanges = {
  ...
  breakdown: (value) => {
    value.breakdown = { ...emptyChangeBreakdown(), code: { additions: 1, deletions: 0 } };
  },
  targetContentId: (value) => {
    value.targetContentId = "content-2";
  },
...
const lineChanges = {
  ...
  sourceHunkIndex: (value) => {
    value.sourceHunkIndex = 1;
  },
  sourceLineIndex: (value) => {
    value.sourceLineIndex = 1;
  },
